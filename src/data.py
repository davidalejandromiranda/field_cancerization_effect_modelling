...
TUMOR_CASES = (
    {"name": "Gastric cancer", "file": DATA_DIR / "gastric_cancer" / "observations.xlsx",
     ...
     "source_publication": "Fan et al. 2024", "doi": "10.1016/j.ijbiomac.2024.134187",
     "figure_panel": "Figure 9",
     "experimental_group": "not specified in source metadata",
     ...
     "experimental_time_unit": "day",
     "observed_to_plot_scale": 1.0, "model_to_plot_scale": 1.0,
     "initial_experimental_volume_mm3": 120.0,
     "model_initial_time": 0.0,
     "first_observation_time": 0.0,
     "first_observation_volume_mm3": 120.0},
    {"name": "Pancreatic cancer", "file": DATA_DIR / "pancreatic_cancer" / "observations.xlsx",
     ...
     "source_publication": "Song et al. 2024", "doi": "10.3390/ijms25073740",
     "figure_panel": "Figure 6B",
     "experimental_group": "not specified in source metadata",
     ...
     "model_initial_time": 0.0,
     "first_observation_time": 0.0,
     "first_observation_volume_mm3": 96.0},
    {"name": "Breast cancer", "file": DATA_DIR / "breast_cancer" / "observations.xlsx",
     ...
     "doi": "10.1016/j.ymthe.2018.09.005; 10.1016/j.jtbi.2023.111593",
     "figure_panel": "not specified in source metadata",
     "experimental_group": "not specified in source metadata",
     "raw_response": "Tumor volume", "raw_unit": "cm^3",
     "transformation": "volume_mm3 = (cell_count / rho) * 1000, rho = 1e7 cells/cm^3",
     "params": (0.3913, 1.0 / EXTENDED_INITIAL_PARAMS[1], 1.675, 1.1835,
                2.1162, 1.824, 0.8135),
     "initial": tuple(BREAST_INITIAL_CONDITIONS), "t_max": 13.0,
     ...
     "model_initial_time": 1.0,
     "first_observation_time": 1.0,
     "first_observation_volume_mm3": 400.0},
    {"name": "Colon cancer", "file": DATA_DIR / "colon_cancer" / "observations.xlsx",
     "raw_file": DATA_DIR / "colon_cancer" / "observations.xlsx",
     "source_publication": "Zhang et al. 2026",
     "doi": "10.1186/s12876-025-04578-4",
     "figure_panel": "Figure 4g",
     "experimental_group": "Ctrl",
     "raw_response": "Tumor volume", "raw_unit": "mm^3",
     "transformation": "none",
     ...
     "model_initial_time": 0.0,
     "model_initial_volume_mm3": 7.67567060905876,
     "first_observation_time": 10.0,
     "first_observation_volume_mm3": 90.0},
    {"name": "Esophageal cancer", "file": DATA_DIR / "esophageal_cancer" / "observations.xlsx",
     ...
     "source_publication": "Minghong et al. 2026", "doi": "10.1007/s12672-026-04457-8",
     "figure_panel": "Figure 1F",
     "experimental_group": "not specified in source metadata",
     "raw_response": "Tumor volume", "raw_unit": "mm^3",
     "transformation": "none",
     ...
     "model_initial_time": 0.0,
     "first_observation_time": 0.0,
     "first_observation_volume_mm3": 91.0},
    {"name": "Skin cancer", "file": DATA_DIR / "skin_cancer" / "observations.xlsx",
     "raw_file": DATA_DIR / "skin_cancer" / "observations.xlsx",
     "source_publication": "Hu et al. 2021", "doi": "10.1007/s00262-021-02946-z",
     "figure_panel": "Figure 1B",
     ...
     "model_initial_time": 0.25,
     "first_observation_time": 0.25,
     "first_observation_volume_mm3": 31.3},
)
